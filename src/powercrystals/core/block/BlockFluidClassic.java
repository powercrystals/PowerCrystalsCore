...
public abstract class BlockFluidClassic extends BlockFluidRoot
{
    ...
    @Override
    public void onBlockPlacedBy(World world, int i, int j, int k, EntityLiving living, ItemStack theItem)
    {
        world.setBlock(i, j, k, blockID, quantaPerBlock - 1, 3);
    }
    ...
    private int getLargerQuanta(IBlockAccess world, int x, int y, int z, int compare)
    {
